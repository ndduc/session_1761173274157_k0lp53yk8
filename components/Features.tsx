export default function Features() {
  const features = [
    ...
    },
    {
      ...
      description: "Tailor every aspect to match your brand and workflow requirements perfectly.",
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Get help whenever you need it with our dedicated 24/7 customer support team.",
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Everything you need to succeed, all in one place. Discover the tools that will transform your workflow.
          </p>
        </div>
